...
-   Crime data:
    ...
    -   <https://kosis.kr/statHtml/statHtml.do?orgId=135&tblId=TX_13501_A048&vw_cd=MT_ETITLE&list_id=C_9&scrId=&language=en&seqNo=&lang_mode=en&obj_var_id=&itm_id=&conn_path=MT_ETITLE&path=%252Feng%252FstatisticsList%252FstatisticsListIndex.do> 

-   Geospatial Data 

    -   <https://gadm.org/download_country_v2.html#google_vignette>

-   Population

    -   <https://data.humdata.org/dataset/kontur-boundaries-korea-republic-of> 

-   Police post locations

    -   <http://download.geofabrik.de/asia/south-korea.html> 

-   Unemployment

    -   Data: <https://kosis.kr/statHtml/statHtml.do?orgId=101&tblId=DT_1DA7107S&vw_cd=MT_ETITLE&list_id=B15&scrId=&language=en&seqNo=&lang_mode=en&obj_var_id=&itm_id=&conn_path=MT_ETITLE&path=%252Feng%252FstatisticsList%252FstatisticsListIndex.do>
